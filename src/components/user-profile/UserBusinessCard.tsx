...
import SocialLinksDisplay from "../ui/social-links/SocialLinksDisplay";
import SocialLinksEditor from "../ui/social-links/SocialLinksEditor";
...
export default function UserBusinessCard({ profile }: UserBusinessCardProps) {
  ...
  const handleCancel = () => {
    ...
    setSocialMedia(profile.social_media || null);
    setError(null);
    setIsEditing(false);
  };

  const handleSocialMediaSave = (data: SocialMedia) => {
    setSocialMedia(data);
  };
          ...
          {!isEditing ? (
            <div className="space-y-5">
              ...
              <div>
                ...
                <SocialLinksDisplay socialMedia={socialMedia} variant="horizontal" size="md" />
              </div>
            </div>
          ) : (
            <div className="space-y-5">
              ...
              <div>
                ...
                <Input
                  ...
                  hint="This is the name that will be shown publicly"
                />
              </div>
