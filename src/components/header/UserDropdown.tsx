...
export default function UserDropdown() {
    ...
    return (
      <div className="relative">
        <div className="flex items-center text-gray-700 dark:text-gray-400">
          ...
          <span className="block mr-1 h-5 w-20 bg-gray-200 dark:bg-gray-700 rounded animate-pulse" />
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="relative">
      ...
      >
        <span className="mr-3 overflow-hidden rounded-full h-11 w-11 bg-brand-100 dark:bg-brand-900/30 flex items-center justify-center">
